# User Tutorial — Navigating GGC Maps

## This tutorial walks the user through the main flow of the web page.

### Landing page (Campus)
- The campus map displays an interactable SVG of the campus. 
...
- The user can highlight one room at a time by clicking on a desired room.
